...
<div class="destino-show-container">
    <?php if ($actividad && $actividad->nombre): ?>
        <section class="destino-hero" style="background-image: url('/Inkatours/static/img/actividades/<?php echo htmlspecialchars($actividad->imagen_principal); ?>');">
                ...
                <div class="destino-sidebar">
                    <div class="booking-box">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <a href="/Inkatours/reservas/crear/actividad/<?php echo $actividad->id; ?>" class="btn btn-primary btn-block">Reservar Ahora</a>
                        <?php else: ?>
                            <a href="/Inkatours/iniciosesion?redirect_to=/Inkatours/reservas/crear/actividad/<?php echo $actividad->id; ?>" class="btn btn-primary btn-block">Iniciar Sesión para Reservar</a>
        ...
        <section class="no-results-section">
            <div class="container">
                <div class="no-results">
                    ...
                    <a href="/Inkatours/actividades" class="btn btn-primary">Ver todas las actividades</a>
                </div>
            </div>
        </section>
    <?php endif; ?>
